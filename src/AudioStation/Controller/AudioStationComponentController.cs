...
namespace AudioStation.Controller
{
    ...
    {
        public event SimpleEventHandler<IAudioStationComponent, IAudioStationComponent.Status> ComponentInitializedEvent;
        public event SimpleEventHandler<IAudioStationComponent, IAudioStationComponent.Status> ComponentStatusChangedEvent;
        ...
        public AudioStationComponentController(IAudioController audioController,
        ...
        public async Task Initialize(DialogEventHandlers.DialogProgressHandler progressHandler)
        {
            ...
            var taskCount = 10;
            var task = 0;
            var status = IAudioStationComponent.Status.Disabled;
        ...
        public T GetComponent<T>() where T : IAudioStationComponent
        {
