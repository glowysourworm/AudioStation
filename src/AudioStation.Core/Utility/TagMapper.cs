...
namespace AudioStation.Core.Utility
{
    ...
    {
        public static TagSmall MapTo(ITagFull tag, VendorNames vendor, Guid vendorRecordId)
        {
            return new TagSmall()
            {
                //Album = tag.Album,
        ...
        public static TagFull Grow(ITagSmall tag)
        {
            return new TagFull()
            {
        ...
        public static TagSmall Shrink(ITagFull tag)
        {
            return new TagSmall()
            {
                //Album = tag.Album,
        ...
        /// </summary>
        public static ATL.Track MapTo(ITagFull tag, string fileName)
        {
        ...
        /// </summary>
        public static TagFull MapFrom(ATL.Track atlTrack)
        {
            //// ATL -> AudioStation
