    ...
    public class LibraryLoaderImportDetailWorker : LibraryWorkerThreadBase
    {
        ...
        private void GetMusicBrainzDetail()
        {
            ...
            _workOutput.MusicBrainzRecordingMatches = _workOutput.AcoustIDResults
                                                                 ...
                                                                 .ToList();
            // Validate Results
            _workOutput.MusicBrainzRecordingMatchSuccess = _workOutput.MusicBrainzRecordingMatches.Any(x => _modelValidationService.ValidateMusicBrainzRecordingImport(x));
        }
