...
namespace AudioStation.Core.Controller
{
    ...
    public class ImageCacheController : IImageCacheController
    {
        ...
        private void Initialize()
        {
            ...
            //
            using (var stream = Assembly.GetAssembly(typeof(AudioStationConfiguration)).GetManifestResourceStream("AudioStation.Core.Resources.Images.placeholder_FullSized.png"))
            {
            ...
            using (var stream = Assembly.GetAssembly(typeof(AudioStationConfiguration)).GetManifestResourceStream("AudioStation.Core.Resources.Images.placeholder_Medium.png"))
            {
                using (var memoryStream = new MemoryStream())
                {
                    stream.CopyTo(memoryStream);
            ...
            using (var stream = Assembly.GetAssembly(typeof(AudioStationConfiguration)).GetManifestResourceStream("AudioStation.Core.Resources.Images.placeholder_Small.png"))
            {
                using (var memoryStream = new MemoryStream())
                {
                    stream.CopyTo(memoryStream);
            ...
            using (var stream = Assembly.GetAssembly(typeof(AudioStationConfiguration)).GetManifestResourceStream("AudioStation.Core.Resources.Images.placeholder_Thumbnail.png"))
            {
                using (var memoryStream = new MemoryStream())
                {
                    stream.CopyTo(memoryStream);
